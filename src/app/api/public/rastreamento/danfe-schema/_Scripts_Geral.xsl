...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="SCRIPTS_GERAL" name="SCRIPTS_GERAL">
    <script language="javascript" src="https://nfe-extranet.sefazvirtual.rs.gov.br/apl/nfe/programas/Scripts/jquery-1.2.6.pack.js?rand=2597439" />
    <script language="javascript" src="https://nfe-extranet.sefazvirtual.rs.gov.br/apl/nfe/programas/Scripts/jquery-1.2.6.min.js?rand=894317" />
    <script language="javascript" src="https://nfe-extranet.sefazvirtual.rs.gov.br/apl/nfe/programas/Scripts/nfe-vis.js?rand=17955575" />
